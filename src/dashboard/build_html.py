          ...
          <div class="overflow-auto rounded border border-slate-200 mb-6">
            <table class="text-sm">
              ...
              <tbody>
                ...
                <tr><td class="px-3 py-2 font-semibold" style="color:var(--text-primary)">Taxa máxima (%/ano)</td><td class="px-3 py-2" style="color:var(--text-secondary)">Taxa de desmatamento do município mais crítico no conjunto filtrado. Reflete o caso extremo do período/região — sobe em anos de maior pressão e cai em anos de redução do desmatamento. Para 2026 usa a previsão do modelo.</td></tr>
                <tr><td class="px-3 py-2 font-semibold" style="color:var(--text-primary)">Municípios taxa > 0,2%/ano</td><td class="px-3 py-2" style="color:var(--text-secondary)">Quantidade de municípios onde a taxa de desmatamento superou 0,2% da área total no ano — aproximadamente 2,5× a média histórica da Amazônia Legal (~0,08%/ano). Funciona como limiar de alerta: em anos de alta pressão esse número sobe; em anos de contenção cai. Valores acima de 150 indicam ciclo preocupante.</td></tr>
              </tbody>
            </table>
          </div>
